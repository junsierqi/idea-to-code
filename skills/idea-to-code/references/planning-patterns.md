...
concrete Files, Execution Details, Implementation Quality Contract, Done
Criteria, and Planned Verification. The quality contract is an execution
guardrail for evidence, assumptions, scope, real/mock paths, regression surface,
safety, shortcut risk, and reviewer checks; it is not a new exploration loop.
